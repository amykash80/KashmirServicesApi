...
namespace KashmirServices.Persistence.Migrations
{
    ...
    [Migration("20231028180825_assignedEngineerUpdated")]
    partial class assignedEngineerUpdated
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KashmirServices.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConfirmationCode = "",
                            CreatedBy = new Guid("a896ff80-05d3-4744-9e80-f8a0b56475b6"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 10, 28, 23, 38, 24, 879, DateTimeKind.Unspecified).AddTicks(5073), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("cdeb950f-84df-4412-a4a5-4815f733df89"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 10, 28, 23, 38, 24, 879, DateTimeKind.Unspecified).AddTicks(5128), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = 1,
                            UserStatus = 1,
                            Username = "admin"
                        });
