...
namespace KashmirServices.Persistence.Migrations
{
    ...
    [Migration("20231027180732_brand-Relation-category")]
    partial class brandRelationcategory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KashmirServices.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConfirmationCode = "",
                            CreatedBy = new Guid("e4d76d3c-5f68-4777-b5e6-1f8475537052"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 10, 27, 23, 37, 32, 6, DateTimeKind.Unspecified).AddTicks(1583), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("b61d0b6d-0430-4217-a0cf-48d05c46bd72"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 10, 27, 23, 37, 32, 6, DateTimeKind.Unspecified).AddTicks(1613), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = 1,
                            UserStatus = 1,
                            Username = "admin"
                        });
