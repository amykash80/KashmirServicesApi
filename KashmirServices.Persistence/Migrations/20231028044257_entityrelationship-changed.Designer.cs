...
namespace KashmirServices.Persistence.Migrations
{
    ...
    [Migration("20231028044257_entityrelationship-changed")]
    partial class entityrelationshipchanged
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KashmirServices.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConfirmationCode = "",
                            CreatedBy = new Guid("60b1fc0d-2dba-44f9-bf7b-1e177b0a70f2"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 10, 28, 10, 12, 57, 491, DateTimeKind.Unspecified).AddTicks(8851), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("8423d3d0-f1a9-4996-b262-7a5a1e6243eb"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 10, 28, 10, 12, 57, 491, DateTimeKind.Unspecified).AddTicks(8890), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = 1,
                            UserStatus = 1,
                            Username = "admin"
                        });
