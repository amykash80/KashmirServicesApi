...
namespace KashmirServices.Persistence.Migrations
{
    ...
    [Migration("20231026063448_category-manager-added")]
    partial class categorymanageradded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KashmirServices.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConfirmationCode = "",
                            CreatedBy = new Guid("aa64c2c5-7c49-4c08-89b7-1ecd2b3fe70e"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 10, 26, 12, 4, 48, 370, DateTimeKind.Unspecified).AddTicks(3465), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("5c701fe9-7a35-448c-8994-d442e119696d"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 10, 26, 12, 4, 48, 370, DateTimeKind.Unspecified).AddTicks(3498), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = 1,
                            UserStatus = 1,
                            Username = "admin"
                        });
