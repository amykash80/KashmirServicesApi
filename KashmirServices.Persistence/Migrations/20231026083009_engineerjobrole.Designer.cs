...
namespace KashmirServices.Persistence.Migrations
{
    ...
    [Migration("20231026083009_engineerjobrole")]
    partial class engineerjobrole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KashmirServices.Domain.Entities.EngineerJobRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KashmirServices.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConfirmationCode = "",
                            CreatedBy = new Guid("0216a0dd-561f-4ba7-8c47-43fbcb0dfbd7"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 10, 26, 14, 0, 9, 382, DateTimeKind.Unspecified).AddTicks(1991), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("1a46d89d-e7b3-457d-8cf8-fc5097c83834"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 10, 26, 14, 0, 9, 382, DateTimeKind.Unspecified).AddTicks(2020), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = 1,
                            UserStatus = 1,
                            Username = "admin"
                        });
