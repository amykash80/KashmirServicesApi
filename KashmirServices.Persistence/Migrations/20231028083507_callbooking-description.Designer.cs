...
namespace KashmirServices.Persistence.Migrations
{
    ...
    [Migration("20231028083507_callbooking-description")]
    partial class callbookingdescription
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KashmirServices.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConfirmationCode = "",
                            CreatedBy = new Guid("e2b47614-a8cc-4eec-ae9b-f874d97a8405"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 10, 28, 14, 5, 6, 772, DateTimeKind.Unspecified).AddTicks(9961), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("a5593025-67f2-4b1e-88ae-a7beb68e9e36"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 10, 28, 14, 5, 6, 772, DateTimeKind.Unspecified).AddTicks(9994), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = 1,
                            UserStatus = 1,
                            Username = "admin"
                        });
