...
namespace KashmirServices.Persistence.Migrations
{
    ...
    [Migration("20231029074741_callbookingjobno-identity")]
    partial class callbookingjobnoidentity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KashmirServices.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConfirmationCode = "",
                            CreatedBy = new Guid("a4ff51f7-6608-4e65-a1d8-742bc4702713"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 10, 29, 13, 17, 41, 652, DateTimeKind.Unspecified).AddTicks(1914), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("1a00f8ff-c7ce-455c-ba36-0792978a0672"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 10, 29, 13, 17, 41, 652, DateTimeKind.Unspecified).AddTicks(1944), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = 1,
                            UserStatus = 1,
                            Username = "admin"
                        });
