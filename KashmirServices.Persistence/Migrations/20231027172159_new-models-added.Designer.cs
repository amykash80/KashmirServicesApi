...
namespace KashmirServices.Persistence.Migrations
{
    ...
    [Migration("20231027172159_new-models-added")]
            ...
            modelBuilder.Entity("KashmirServices.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConfirmationCode = "",
                            CreatedBy = new Guid("013fd8c2-95b9-46f0-8cf6-e10f3065a758"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 10, 27, 22, 51, 58, 250, DateTimeKind.Unspecified).AddTicks(5768), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("f0ebabc6-eff7-4ba4-a6e4-424478ddc927"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 10, 27, 22, 51, 58, 250, DateTimeKind.Unspecified).AddTicks(5806), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = 1,
                            UserStatus = 1,
                            Username = "admin"
                        });
